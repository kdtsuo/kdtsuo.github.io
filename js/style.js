...
function handleIntersection(entries) {
  entries.forEach((entry) => {
    ...
    if (entry.isIntersecting) {
      slider(".slider-1", ".slider-1 img", ".slider-nav-1 a", time + delay * 1);
      slider(".slider-2", ".slider-2 img", ".slider-nav-2 a", time + delay * 2);
      slider(".slider-3", ".slider-3 img", ".slider-nav-3 a", time + delay * 3);
      slider(".slider-4", ".slider-4 img", ".slider-nav-4 a", time + delay * 4);
    }
  });
}
const options = {
