...
function Navbar({ isPanelOpen, togglePanel }) {
    return (
        <nav className={`${isPanelOpen ? 'opacity-0' : 'opacity-100'} fixed w-full z-10 bg-gradient-to-t from-transparent to-lightblue flex justify-between items-center px-10 py-8`}>
